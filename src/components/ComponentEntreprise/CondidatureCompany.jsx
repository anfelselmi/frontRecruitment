                      ...
                      <table class="table table-striped projects">
                        ...
                        <tbody>
                          {condidatures.map((c, i) => {
                            console.log(condidatures, 'iii');
                            return (
                              <tr>
                                <td>{i + 1}</td>
                                <td>{c.nom}</td>
                                <td>{c.prenom}</td>
                                <td>{c.candidate && c.candidate.phone}</td>
                                <td>{c.candidate && c.candidate.email}</td>
...
export default CondidatureCompany;
